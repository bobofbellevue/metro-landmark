                        ...
                        <table className="w-full divide-y divide-gray-200">
                            <thead className="bg-gray-50">
                                <tr>
                                    ...
                                    <th className="px-6 py-3 text-xs font-medium tracking-wider text-left text-gray-500 uppercase"><button onClick={() => requestSort('name')} className="flex items-center">Name {getSortIndicator('name')}</button></th>
                                    <th className="px-6 py-3 text-xs font-medium tracking-wider text-left text-gray-500 uppercase"><button onClick={() => requestSort('contact')} className="flex items-center">Contact {getSortIndicator('contact')}</button></th>
                                    <th className="px-6 py-3 text-xs font-medium tracking-wider text-left text-gray-500 uppercase"><button onClick={() => requestSort('property')}>Property / Unit {getSortIndicator('property')}</button></th>
                                    <th className="px-6 py-3 text-xs font-medium tracking-wider text-left text-gray-500 uppercase"><button onClick={() => requestSort('lease_status')}>Lease Status {getSortIndicator('lease_status')}</button></th>
                                </tr>
                            </thead>
                            <tbody className="bg-white divide-y divide-gray-200">
                                {displayedTenants.map(t => (
                                    <tr key={t.user_id} className={t.is_archived ? 'opacity-60 italic' : ''}>
                                        ...
                                        <td className="px-6 py-4 whitespace-nowrap">{t.address_line_1 ? `${t.address_line_1}${t.unit_number ? `, Unit ${t.unit_number}` : ''}` : 'None'}</td>
                                        <td className="px-6 py-4 whitespace-nowrap">
                                            {(() => {
