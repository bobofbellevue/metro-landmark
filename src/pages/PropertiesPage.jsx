                        ...
                        <table className="w-full divide-y divide-gray-200">
                            <thead className="bg-gray-50">
                                <tr>
                                    ...
                                    <th className="px-6 py-3 text-xs font-medium tracking-wider text-left text-gray-500 uppercase"><button onClick={() => requestSort('address')} className="flex items-center">Address {getSortIndicator('address')}</button></th>
                                    <th className="px-6 py-3 text-xs font-medium tracking-wider text-left text-gray-500 uppercase"><button onClick={() => requestSort('landlord_name')} className="flex items-center">Landlord {getSortIndicator('landlord_name')}</button></th>
                                    <th className="px-6 py-3 text-xs font-medium tracking-wider text-left text-gray-500 uppercase"><button onClick={() => requestSort('property_type')} className="flex items-center">Type {getSortIndicator('property_type')}</button></th>
                                    <th className="px-6 py-3 text-xs font-medium tracking-wider text-left text-gray-500 uppercase"><button onClick={() => requestSort('unit_count')} className="flex items-center">Units {getSortIndicator('unit_count')}</button></th>
                                    <th className="px-6 py-3 text-xs font-medium tracking-wider text-left text-gray-500 uppercase"><button onClick={() => requestSort('management_display')} className="flex items-center">Management {getSortIndicator('management_display')}</button></th>
                                </tr>
                            </thead>
                            <tbody className="bg-white divide-y divide-gray-200">
                                {displayedProperties.map(p => (
                                    <tr key={p.property_id} className={p.is_archived ? 'opacity-60 italic' : ''}>
                                        ...
                                        <td className="px-6 py-4 whitespace-nowrap">{p.landlord_name}</td>
                                        <td className="px-6 py-4 whitespace-nowrap">{p.property_type}</td>
                                        <td className="px-6 py-4 text-sm text-gray-700 whitespace-nowrap">{p.unit_count || 0}</td>
                                        <td className="px-6 py-4 text-sm text-gray-500">
